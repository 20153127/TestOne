...
$(document).ready(function() {
	...
	<div	class="menuList">
	<div><a	target="mainAction" href="need.jsp">需求填报</a></div>
	<div><a	target="mainAction" href="${pageContext.request.contextPath}/needservlet?method=find">查看需求</a></div>
	<div><a	target="mainAction" href="typefind.jsp">分类浏览</a></div>
	</div>
		</div>
		</div>
		</div>
