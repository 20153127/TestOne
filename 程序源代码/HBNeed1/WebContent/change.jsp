...
<body bgcolor="#DDF2FC" >
	...
	<div class="table" align="center">
		<form action="${pageContext.request.contextPath }/needservlet?method=change&id=${b.id}" method="post"	id="checkForm">
			<table width="800" height="497.6" border="1">
				...
				<td height="60"><div align="center">拟投入资金总额</div></td>
					...
					<input id="money" name="money" type="text" value="${b.money}"	style="width: 80px" height="98%" />
					万元
				</tr>
				<tr>
