...
<body>
	...
	<table id="datatable" width="100%" border="0" cellpadding="0"
		...
		<tr>
			...
			<td bgcolor="d3eaef" width="20%" height="20"><div align="center">角色修改操作</div></td>
		</tr>
		<c:forEach items="${c }" var="item" varStatus="vs">
			...
			<tr>
				...
				<c:if test="${item.juese=='管理 员'}">
					<td width='10%' height='20'><div align='center'>管理员</div></td>
				</c:if>
				<td width='20%' height='20'><div align='center'>
						<a
							href="${pageContext.request.contextPath }/userservlet?method=findbyuser&username=${item.username}">修改</a>
					</div></td>
			</tr>
		</c:forEach>
	</table>
