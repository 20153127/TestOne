...
<body onload="createCode()"	bgcolor="#DDF2FC">
	<div align="center">
	<form action="${pageContext.request.contextPath }/userservlet?method=createnew" method="post" id="checkForm">
		...
		<table>
			...
			<tr>
				<td>*身份证号</td>
				<td><input type="text" name="shenfen"></td><td></td><td><span id="">请填写正确的身份证号</span></td>
			</tr>
			...
			<tr>
				...
				<tr>
				<td>机构全称</td>
				<td><input type="text" name="danwei"><span id=""></span></td>
			</tr>
				<tr>
				<td>专业方向</td>
				<td><input type="text" name="zhuanye"><span id=""></span></td>
			</tr>
				<tr>
				<td>所在行业</td>
				<td><input type="text" name="hangye"><span id=""></span></td>
			</tr>
				<tr>
				<td>教育程度</td>
				<td><input type="text" name="jiaoyu"><span id=""></span></td>
			</tr>
			<tr>
				<td>昵称</td>
				<td><input type="text" name="nicheng"><span id=""></span></td>
			</tr>
			<tr>
				<td>通讯地址</td>
				<td><input type="text" name="tongxun"></td><td></td><td><span id="">请填写详细地址，以便与人联系</span></td>
			</tr>
			<tr>
				<td>邮政编码</td>
				<td><input type="text" name="bianma"><span id=""></span></td>
			</tr>
				<tr>
				<td>手机</td>
				<td><input type="text" name="phone"><span id=""></span></td>
			</tr>
			
				<tr>
				<td>固定电话</td>
				<td><input type="text" name="guding"><span id=""></span></td>
			</tr>
				<tr>
				<td>邮箱</td>
				<td><input type="text" name="address"><span id=""></span></td>
			</tr>
			<tr>
				<td>qq</td>
				<td><input type="text" name="qq"><span id=""></span></td>
			</tr>
			<tr>
				<td>msn</td>
				<td><input type="text" name="msn"><span id=""></span></td>
			</tr>
				<td>验证码</td>
			<td>	<input type="text" name="codeCheck" class="form-control"	id="codeCheck" placeholder="Code">
			<input type="text" onclick="createCode()" readOnly="true" id="checkCode" class="unchanged" style="width: 80px;color:red;"  />
			</td>
			<tr>
